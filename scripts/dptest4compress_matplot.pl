...
#keep data files
`rm -rf $mainPath/matplot_data4compress`;
...
# get atom number for normalizing energy
        `cp  ./temp.e.out $mainPath/matplot_data4compress/$make_plots[$_]-Oritemp.e-graph$temp.out`;#for raw data
        `cp  ./temp.f.out $mainPath/matplot_data4compress/$make_plots[$_]-temp.f-graph$temp.out`;#for raw data
        `cp  ./temp.v.out $mainPath/matplot_data4compress/$make_plots[$_]-temp.v-graph$temp.out`;#for raw data
        ...
        `cp  ./temp.e.out $mainPath/matplot_data4compress/$make_plots[$_]-temp.e-graph$temp.out`;#for raw data
